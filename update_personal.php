...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        <html>
        <head>
            <meta http-equiv='refresh' content='4;url=view_personal.php'>
            <style>
                body { font-family: Arial; text-align: center; margin-top: 100px; }
            </style>
        </head>
        <body>
            <h2>Personal details updated successfully!</h2>
            <p>You will be redirected to the view details page shortly...</p>
        </body>
        </html>";
    } else {
